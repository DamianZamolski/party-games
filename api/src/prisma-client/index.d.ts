...
export namespace Prisma {
  ...
  */
   ...
   * RoomCountOutputType without action
   */
  export type RoomCountOutputTypeCountUsersArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    users<T extends Room$usersArgs<ExtArgs> = {}>(
      args?: Subset<T, Room$usersArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
  ...
  export type UserOmit<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = $Extensions.GetOmit<'id' | 'roomId', ExtArgs['result']['user']>;
  ...
  export type UserCreateNestedManyWithoutRoomInput = {
    create?:
      | XOR<UserCreateWithoutRoomInput, UserUncheckedCreateWithoutRoomInput>
      | UserCreateWithoutRoomInput[]
      | UserUncheckedCreateWithoutRoomInput[];
    connectOrCreate?:
      | UserCreateOrConnectWithoutRoomInput
      | UserCreateOrConnectWithoutRoomInput[];
  ...
  export type UserUpdateManyWithoutRoomNestedInput = {
    ...
    update?:
      ...
      | UserUpdateWithWhereUniqueWithoutRoomInput[];
    updateMany?:
      | UserUpdateManyWithWhereWithoutRoomInput
      | UserUpdateManyWithWhereWithoutRoomInput[];
  ...
  export type UserUpdateManyWithWhereWithoutRoomInput = {
    ...
    data: XOR<
      ...
      UserUncheckedUpdateManyWithoutRoomInput
    >;
  };
